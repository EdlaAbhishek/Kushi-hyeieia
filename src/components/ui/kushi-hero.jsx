...
export default function KushiHero() {
    ...
    return (
        ...
        >
            {/* 1. Atmospheric Wave & Gradient Depth Background */}
            <GradientWave />
            ...
            >
                {/* Main Hero Panel with Glassmorphism & Medical Tone */}
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: '0 20px 40px -15px rgba(15, 23, 42, 0.07), 0 0 0 1px rgba(255, 255, 255, 0.8)',
                        display: 'flex',
                        flexDirection: 'column',
                        alignItems: 'center'
                    }}
