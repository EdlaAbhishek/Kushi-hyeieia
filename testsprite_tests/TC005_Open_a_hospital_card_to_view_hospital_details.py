...
async def run_test():
    ...
    try:
        ...
        # -> Click the cookie consent 'Accept & Continue' button, then fill email and password and submit the Sign In form.
        ...
        # -> Click the 'Hospitals' link in the main navigation to open the hospitals list (element index 182).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div[2]/header/div/nav/a[3]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the first hospital card (or its actionable entry) in the hospitals list to open the hospital details page.
        frame = context.pages[-1]
        # Click element
