...
async def run_test():
    ...
    try:
        ...
        # -> Accept the Data Privacy & Security Consent, fill the email and password fields, and click Sign In (this will attempt to log in).
        ...
        # -> Click the 'Sign In' button to submit the login form and proceed to the app dashboard (then navigate to /emergency).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div[2]/div/div/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Navigate to /emergency (explicit navigate step from the test plan).
        await page.goto("http://localhost:4173/emergency")
