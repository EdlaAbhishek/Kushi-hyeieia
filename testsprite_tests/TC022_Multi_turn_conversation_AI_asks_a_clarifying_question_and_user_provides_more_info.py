...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (http://localhost:4173/login) to load the login page and reveal interactive elements.
        await page.goto("http://localhost:4173/login")
        
        # -> Click 'Accept & Continue' on the Data Privacy & Security Consent banner to remove overlay, then fill email/password and click 'Sign In'.
        ...
        # -> Click the 'Sign In' button to submit the login form (click element index 123).
        frame = context.pages[-1]
        # Click element
