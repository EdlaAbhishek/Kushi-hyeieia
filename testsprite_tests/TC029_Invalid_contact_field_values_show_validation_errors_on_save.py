...
async def run_test():
    ...
    try:
        ...
        # -> Dismiss the privacy consent, enter provided credentials into the email and password fields, and click 'Sign In' to attempt login.
        ...
        # -> Click the 'Sign In' button to submit the login form (element index 123).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div[2]/div/div/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Profile' link in the main navigation to open the Profile page (click element index 306).
        frame = context.pages[-1]
        # Click element
